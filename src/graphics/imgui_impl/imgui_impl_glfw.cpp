...
//  2021-01-20: Inputs: calling new io.AddKeyAnalogEvent() for gamepad support, instead of writing directly to
//  io.NavInputs[]. 2022-01-17: Inputs: calling new io.AddMousePosEvent(), io.AddMouseButtonEvent(),
//  io.AddMouseWheelEvent() API (1.87+). 2022-01-17: Inputs: always calling io.AddKeyModsEvent() next and before key
...
#define GLFW_HAS_OSX_WINDOW_POS_FIX                                                                                    \
	(GLFW_VERSION_MAJOR * 1000 + GLFW_VERSION_MINOR * 100 + GLFW_VERSION_REVISION * 10 >= 3310                         \
	...
	#define GLFW_HAS_NEW_CURSORS                                                                                       \
		(GLFW_VERSION_MAJOR * 1000 + GLFW_VERSION_MINOR * 100 >= 3400                                                  \
...
static void ImGui_ImplGlfw_UpdateKeyModifiers(int mods)
{
	...
	ImGuiKeyModFlags key_mods = ((mods & GLFW_MOD_CONTROL) ? ImGuiKeyModFlags_Ctrl : 0) |

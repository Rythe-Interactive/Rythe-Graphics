...
namespace rythe::rendering
{
	...
	public:
		...
		{
			auto temp = rsl::delegate<
				void(app::window&, camera&, const camera::camera_input&, rsl::span)>::template create<T, Func>(*ptr);
			m_onGuiRender.push_back(
				rsl::force_cast<rsl::delegate<void(app::window&, camera&, const camera::camera_input&, rsl::span)>>(temp
				)
			);
		}
	...
	private:
		 ...
		 */
		static rsl::multicast_delegate<void(app::window&, camera&, const camera::camera_input&, rsl::span)>
			m_onGuiRender;
	};
} // namespace rythe::rendering
